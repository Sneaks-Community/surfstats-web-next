...
const backgroundPalettes: Record<BackgroundFamily, Record<string, string>> = {
  slate: {
    50: '#f8fafc', 100: '#f1f5f9', 200: '#e2e8f0', 300: '#cbd5e1', 400: '#94a3b8',
    500: '#64748b', 600: '#47556e', 700: '#334155', 800: '#1e293b', 900: '#0f172a', 950: '#020617',
  },
  gray: {
...
export function generateThemeStyles(): string {
  ...
  const primaryDark = colorPalettes[config.dark.primary];
  const secondaryDark = colorPalettes[config.dark.secondary];
  const bgDark = backgroundPalettes[config.dark.background];
  
  const primaryLight = colorPalettes[config.light.primary];
  const secondaryLight = colorPalettes[config.light.secondary];
  const bgLight = backgroundPalettes[config.light.background];
...
:root, .dark {
  ...
  --color-background-tertiary: ${bgDark[800]};
  
  --color-surface: ${bgDark[900]};
  --color-surface-hover: ${bgDark[800]};
  --color-surface-active: ${bgDark[700]};
  
  --color-border: ${bgDark[800]};
  --color-border-hover: ${bgDark[700]};
  --color-border-focus: ${primaryDark[500]};
  
  --color-text: ${bgDark[50]};
  --color-text-muted: ${bgDark[400]};
  --color-text-placeholder: ${bgDark[500]};
}
...
.light {
  ...
  --color-background-tertiary: ${bgLight[200]};
  
  --color-surface: ${bgLight[100]};
  --color-surface-hover: ${bgLight[200]};
  --color-surface-active: ${bgLight[300]};
  
  --color-border: ${bgLight[200]};
  --color-border-hover: ${bgLight[300]};
  --color-border-focus: ${primaryLight[500]};
