...
import type CompletionBreakdownChartImpl from './CompletionBreakdownChart';
...
const CompletionBreakdownChart = dynamic(() => import('./CompletionBreakdownChart'), {
  ssr: false,
  loading: () => (
...
export default function LazyCompletionBreakdownChart(
  props: ComponentProps<typeof CompletionBreakdownChartImpl>
) {
  return <CompletionBreakdownChart {...props} />;
}
